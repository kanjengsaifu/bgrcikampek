...
(1, 'WBP', 'coba1', 'coba1', 'coba'),
(2, 'INDO LIBERTY', '', '', ''),
(3, 'IKPT', '', '', ''),
(4, 'PERDANA MANDIRI', '', '', ''),
(5, 'PT INDOFOOD', 'KAWASAN JABABKE II CIKARANG', '122333-345-0-1', 'MR OH');
...
INSERT INTO `multiuser` (`id_user`, `nama_lengkap`, `username`, `password`, `jabatan`, `email`, `phone`, `alamat`, `foto`, `type_user`, `tgl`) VALUES
...
(3, 'Jamil Ahmad', 'jamil', '0e2cc23df7e37a854499f9d918b0219d', '', '', '', '', '', '1', '2014-06-26 10:41:28');
...
(1, '', 'KAWASAN JABABKE II CIKARANG', '122333-345-0-1', 'MR OH'),
(2, '', 'KAWASAN JABABKE II CIKARANG', '122333-345-0-1', 'MR OH');
