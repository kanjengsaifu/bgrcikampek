    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="white-box">
						...
						<button data-toggle="modal" data-target="#responsive-modal" class="btn btn-default waves-effect"><span class="glyphicon glyphicon-plus"></span>Tambah Vendor</button>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0">Data Vendor</h3>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Tambah  Vendor Baru</h4> </div>
