...
if($_POST['submit']=='Simpan'){
	mysql_query("insert into spk values('','$no_spk','$no_proposal','$no_surlan','$tgl_spk_terbit','$tgl_spk_berakhir','$jangka_waktu','$asal','$tujuan','$jumlah_rit','$realisasi_rit','$biaya_rit','$harga_rit','$nilai_spk','$biaya','$laba_rugi','$pm','$id_spk')");
	header("location:spk.php?spk=$id_spk");
}

if($_POST['submit']=='Update'){
	mysql_query("update spk set no_spk='$no_spk', no_proposal='$no_proposal', surlan='$no_surlan', tgl_spk_terbit='$tgl_spk_terbit',tgl_spk_berakhir='$tgl_spk_berakhir',jangka_waktu='$jangka_waktu',asal='$asal',tujuan='$tujuan',jumlah_rit='$jumlah_rit',realisasi_rit='$realisasi_rit',biaya_rit='$biaya_rit',harga_rit='$harga_rit',nilai_spk='$nilai_spk',biaya='$biaya',laba_rugi='$laba_rugi',pm='$pm',id_customer='$id_spk' where id='$id'");
	header("location:spk.php?spk=$id_spk");
}
 ?>
