...
$pdf->Cell(25.5,0.7,"Laporan Data Customer",0,10,'C');
$pdf->ln(1);
$pdf->SetFont('Arial','B',10);
...
$pdf->Cell(7, 0.8, 'Nama Customer', 1, 0, 'C');
$pdf->Cell(3, 0.8, 'Alamat', 1, 0, 'C');
$pdf->Cell(4, 0.8, 'No NPWP', 1, 0, 'C');
$pdf->Cell(4.5, 0.8, 'Nama Pimpinan', 1, 1, 'C');
...
while($lihat=mysql_fetch_array($query)){
	$pdf->Cell(1, 0.8, $no , 1, 0, 'C');
	$pdf->Cell(7, 0.8, $lihat['nm_cus'],1, 0, 'C');
	$pdf->Cell(3, 0.8, $lihat['alamat'], 1, 0,'C');
	$pdf->Cell(4, 0.8, $lihat['npwp'],1, 0, 'C');
	$pdf->Cell(4.5, 0.8, $lihat['nm_pimpinan'], 1, 1,'C');
