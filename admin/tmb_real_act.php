...
if($_POST['submit']=='Update'){
	mysql_query("update realisasi set no_spk='$no_spk', tgl_realisasi='$tgl_realisasi', armada='$armada',asal='$asal',tujuan='$tujuan',party='$party',satuan='$satuan',nopol='$nopol',no_surjl='$no_surjl',biaya_armada='$biaya_armada',operasional_mb='$operasional_mb',total_biaya='$total_biaya',pendapatan='$pendapatan',laba='$laba',pm='$pm',dn='$dn' where id='$id'");
